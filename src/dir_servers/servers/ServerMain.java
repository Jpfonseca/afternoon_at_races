package dir_servers.servers;

import extras.config;
import interfaces.Register;
import servers.InterfaceServers;
        ...
        if (args.length == 1) {
            ...
            switch (config.baseListenPort + service) {
                ...
                case config.repoServerPort:             // Repo portNumb = 22225
                    ...
                    try {
                        repoStub = (GeneralInformationRepositoryInterface) UnicastRemoteObject.exportObject(repo, config.RMI_REGISTRY_PORT);
                    } catch (RemoteException e) {
